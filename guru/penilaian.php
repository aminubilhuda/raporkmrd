<?php  
    ...
    WHERE id_mapel_kelas=? AND tahun=? AND semester=?");
    $stmt->bind_param("sss", $orderID, $sekolah['tahun'], $sekolah['semester']);
    $stmt->execute();
        ...
        <form method="POST">
          <div class="card-body table-responsive">
            <div class="d-flex justify-content-between align-items-center">
              <p>
                <button type="submit" name="simpannilai" class="btn btn-success">Simpan Nilai
                  Formatif</button>
              <h3 class="mx-auto" style="padding-right: 140px;">Penilaian <i class="text-danger">Formatif</i>
            ...
            <table class="table table-striped table-bordered table-sm">
              <thead>
                <tr class="bg-warning">
                  ...
                  <th colspan="<?php echo $jumlahtp ?>" style="text-align:center; vertical-align:middle;">Tujuan
                    Pembelajaran</th>
                ...
                <tr class="bg-warning">
                  <?php
                                    ...
                                    ?>
                  <th class="fixed-table" style="text-align:center; vertical-align:middle; width:70px;">
                    <a href="" data-toggle="tooltip" data-placement="top"
                      title="<?php echo $rdatatujuan['tujuan']; ?>">F.
                      <?php echo $nomor++?></a> <br>
                    <form method="POST">
                      <a href="" class="btn btn-success btn-custom btn-sm" data-toggle="modal" data-placement="top"
                        data-toggle="tooltip" title="Inputkan Angka Serentak" data-target="#myModalAdd" title="Add"
                        onclick="setActiveColumn(this)">
                        <i class="fas fa-th-list"></i>
                      </a>
                      <input type="hidden" name="id_tujuan" value="<?php echo $rdatatujuan['id_tujuan']; ?>">
                      <button type="submit" name="delete_tujuan" class="btn btn-danger btn-custom btn-sm"
              ...
              <tbody id="student-table-body">
                <?php
                                ...
                                WHERE siswa_kelas.tahun=?
                                AND siswa_kelas.semester=?
                                AND siswa_kelas.id_kelas=?
                                AND mapel_siswa.tahun=?
                ...
                <tr>
                  ...
                  <td style="text-align:center; vertical-align:middle; width:5%;" class="input-column"
                    ...
                    <input type="text" name="nilai[]" oninput="
           if(this.value > 100) {
           ...
           if(this.value < 0) {
               ...
               this.value = 0;
           }" min="0" max="100" class="form-control" style="width:50px; text-align:center;" autocomplete="off"
                      placeholder="-" value="<?php echo $nilaiformatif['nilai']?>">
                    <input type="hidden" name="siswa[]" value="<?php echo $rsiswakelas['id_siswa']?>">
                    <input type="hidden" name="tujuan[]" value="<?php echo $rdatatujuan['id_tujuan']?>">
                  </td>
                  <?php } ?>
          ...
          <div class="card-body table-responsive">
            <div class="d-flex justify-content-between align-items-center">
              <p>
                <button type="submit" name="simpannilai" class="btn btn-success">Simpan Nilai
                  Sumatif</button>
              <h3 class="mx-auto" style="padding-right: 140px;">Penilaian <i class="text-danger">Sumatif</i>
                <?php echo $mapelkelas['nama_mapel']?> -
                <?php echo $mapelkelas['nama_kelas']?></h3>
              </p>
            </div>
              ...
              <thead>
                ...
                <tr class="bg-info">
                  ...
                  <th style="text-align:center; vertical-align:middle; width:70px;"
                    ...
                    <form method="POST">
                      <a href="" class="btn btn-success btn-custom btn-sm" data-toggle="modal" data-placement="top"
                        data-toggle="tooltip" title="Inputkan Angka Serentak" data-target="#myModalAddSumatif"
                        onclick="setActiveColumn(<?php echo $nomor - 1; ?>)">
                        <i class="fas fa-th-list"></i>
                      </a>
                      <input type="hidden" name="id_tujuan" value="<?php echo $rdatatujuan['id_tujuan']; ?>">
                      <button type="submit" name="hapus_nilai_s" class="btn btn-danger btn-custom btn-sm"
                        data-toggle="tooltip" data-placement="top" title="Hapus"
                        onclick="return confirm('Apakah Anda yakin ingin menghapus nilai tujuan pembelajaran ini dengan nama: <?php echo $rdatatujuan['tujuan']; ?> ?');">
                        <i class="fas fa-times"></i>
                      </button>
           ...
           if(this.value < 0) {
               alert('Nilai tidak boleh kurang dari 0!');
               this.value = 0;
           }" min="0" max="100" style="width:50px; text-align:center;" class="form-control" placeholder="-"
                      autocomplete="off" value="<?php echo $nilaisumatifph['nilai']?>">
        ...
        <form method="POST">
          <div class="card-body table-responsive">
            ...
            <table class="table table-bordered table-striped table-sm">
              <thead>
                <tr>
                  ...
                  <th colspan="<?php echo $jumlahtpmiddleformatif ?>" class="text-center align-middle table-warning">
                    Nilai Formatif
                    <a href="" class="btn btn-success" data-toggle="modal" data-target="#myModal">Tambah TP F</a>
                  </th>
                  ...
                  <th colspan="<?php echo $jumlahtpmiddleph ?>" class="text-center align-middle table-warning">
                    Nilai Sumatif
                    <a href="" class="btn btn-primary" data-toggle="modal" data-target="#myModalPh">Tambah TP S</a>
                  </th>
                  <th rowspan="2" class="text-center align-middle table-info" data-toggle="tooltip" data-placement="top"
                ...
                <tr>
                  <?php
                                    ...
                                    while($rdatatujuan = $datatujuan->fetch_array()){
                                    ?>
                  <th style="text-align:center; vertical-align:middle; width:5%;" class="table-warning"
                    title="<?php echo $rdatatujuan['tujuan']?>" data-toggle="tooltip" data-placment="top">
                    <a href="">TP.
                      <?php echo $nomor++?></a>
                  </th>
                  <?php } ?>
                  <?php
                                    ...
                                    ?>
                  <th class="text-center align-middle table-warning" style="width:5%;" data-toggle="tooltip"
                    data-placment="top" title="<?php echo $rdatatujuan2['tujuan']?>"><a href="">TP.
                      <?php echo $nomor++?></a></th>
                  <?php } ?>
                </tr>
              </thead>
           ...
           if(this.value < 0) {
               alert('Nilai tidak boleh kurang dari 0!');
               this.value = 0;
           }" min="0" max="100" style="width:50px; text-align:center;" placeholder="-" class="form-control"
                      autocomplete="off" value="<?php echo $data_nnilai_sumatif_ts ?>">
                    <input type="hidden" name="siswa[]" style="width:100%;" autocomplete="off"
                      value="<?php echo $rsiswakelas['id_siswa']?>">
                  </td>
        ...
        <form method="POST">
          <div class="card-body table-responsive">
              ...
              <thead>
                <tr style="background-color:#fae696;">
                  ...
                  <th colspan="<?php echo $totalTPFormatif ?>" class="text-center align-middle">Nilai
                    Formatif <a href="" class="btn btn-primary" data-toggle="modal" data-placment="top"
                      title="Tambah Nilai Formatif" data-target="#myModal">Tambah TP
                      F</a></th>
                  <?php } ?>
                  <th rowspan="2" class="text-center align-middle table-dark" title="Nilai Akhir FORMATIF">NAF</th>
                  <th colspan="<?php echo $jumlahtp; ?>" class="text-center align-middle">Nilai
                    Sumatif</th>
                  <th rowspan="2" class="text-center align-middle table-dark" title="Nilai Akhir SUMATIF">NAS</th>
                  ...
                  <th rowspan="2" class="text-center align-middle table-dark" data-toggle="tooltip" data-placment="top"
                    title="Nilai Akhir Rapor Semester">Nilai Akhir <br>
                    Rapor Semester</th>
                </tr>
                <tr style="background-color:#fae696;">
                  <?php
                                    ...
                                    if ($totalTPFormatif > 0) {
                                        ...
                                        while($rdatatujuan = $datatujuan->fetch_array()){
                                    ?>
                  <th class="text-center align-middle" style="width:5%;" data-toggle="tooltip" data-placment="top"
                    title="<?php echo $rdatatujuan['tujuan']?>"><a href="">TP.
                      <?php echo $nomor++?></a></th>
                  <?php } } ?>
           ...
           if(this.value < 0) {
               alert('Nilai tidak boleh kurang dari 0!');
               this.value = 0;
           }" min="0" max="100" style="width:100%; text-align:center;" placeholder="-" class="form-control"
                      autocomplete="off" value="<?php echo $data_nnilai_sumatif_as ?>">
                    <input type="hidden" name="siswa[]" style="width:100%;" autocomplete="off"
                      value="<?php echo $rsiswakelas['id_siswa']?>">
                  </td>
