...
window.location.href = "login.php";
    ...
    include "../bot/wa2/functionbot.php";
                        ...
                        <table class=" table table-striped table-bordered fixed-table">
                            <thead>
                                <tr class="bg-warning">
                                    ...
                                    <th rowspan="2" style="text-align:center; vertical-align:middle;">Jumlah Nilai
                                        Formatif</th>
                            ...
                            <tbody id="student-table-body">
                                <?php
                                $stmt = $mysqli->prepare("SELECT * FROM siswa_kelas 
                                JOIN siswa ON siswa_kelas.id_siswa = siswa.id_siswa
                                WHERE tahun=? AND semester=? AND id_kelas=? ORDER BY nama_siswa ASC");
                                $stmt->bind_param("sss", $sekolah['tahun'], $sekolah['semester'], $id_kelas);
                                $stmt->execute();
                        ...
                        <table class="table table-striped table-bordered fixed-table">
                            <thead>
                                <tr class="bg-info">
                                    ...
                                    <th colspan="<?php echo $jumlahtp ?>"
                                        style="text-align:center; vertical-align:middle;">Tujuan Pembelajaran</th>
                                    <th rowspan="2" style="text-align:center; vertical-align:middle;">Jumlah <br>Nilai
                                        Sumatif</th>
                                    <th rowspan="2" style="text-align:center; vertical-align:middle;">Rata-rata
                                        <br>Nilai Sumatif
                                    </th>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="<?php echo $jumlahtpmiddleformatif ?>"
                                        ...
                                        <a href="" class="btn btn-success" data-toggle="modal"
                                            data-target="#myModal">Tambah Nilai Formatif</a>
                                    </th>
                                    ...
                                    <th colspan="<?php echo $jumlahtpmiddleph ?>"
                                        ...
                                        <a href="" class="btn btn-primary" data-toggle="modal"
                                            data-target="#myModalPh">Tambah Nilai Sumatif</a>
                                    </th>
                                    <th rowspan="2" class="text-center align-middle table-info" data-toggle="tooltip"
                                ...
                                <tr>
                                    ...
                                    <th style="text-align:center; vertical-align:middle; width:5%;"
                                        class="table-warning">
                                        <a href="" class="btn btn-warning">TP.
                                            <?php echo $nomor++?></a>
                                    </th>
                                    <?php } ?>
                                    <?php
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <?php
                                        echo $jumlah = $data_nnilai_sumatif_ts + $ratanilaisumaitfformatifTS + $ratanilaisumaitfphTS;
                                        ?>
                                    </td>
                                    <td class="text-center align-middle table-info">
                        ...
                        <table class="table table-striped table-bordered">
                                ...
                                <tr style="background-color:#fae696;">
                                    ...
                                    <th colspan="<?php echo $totalTPFormatif ?>" class="text-center align-middle">Nilai
                                        Formatif <a href="" class="btn btn-primary" data-toggle="modal"
                                            data-target="#myModal">Tambah Nilai
                                            Formatif</a></th>
                                    <?php } ?>
                                    ...
                                    <th rowspan="2" class="text-center align-middle table-dark"
                                        title="Nilai Akhir Rapor Semester">NARS</th>
                                </tr>
                                <tr style="background-color:#fae696;">
                                    <?php
                                    ...
                                    <th class="text-center align-middle" style="width:5%;" data-toggle="tooltip"
                                        title="<?php echo $rdatatujuan['tujuan']?>">TP.
                                        <?php echo $nomor++?></th>
                                    <?php } } ?>
                                    ...
                                    ?>
                                    <th class="text-center align-middle" style="width:5%;" data-toggle="tooltip"
                                        title="<?php echo $rdatatujuan2['tujuan']?>">TP.
                                        <?php echo $nomor++?></th>
                                    <?php } ?>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <?php echo $jumlah = $data_nnilai_sumatif_ts + $rata_nilai_sumaitf_formatif_as + $ratanilaisumaitfphTS; ?>
                                    </td>
                                    <td class="text-center align-middle table-dark">
                                        <?php echo "<b>" . $datarata = round(($jumlah / 3), 2) . "</b>"; ?>
                                    </td>
