...
<?php
    ...
    if(isset($_POST['simpan'])){
            ...
            $simpan = mysqli_query($mysqli,"UPDATE proyek_kelas SET id_tema='$id_tema', judul_proyek='$judul', deskripsi_singkat='$deskripsi_singkat', id_user='$id_user' WHERE id_proyek_kelas='$_GET[orderID]'");
            if($simpan){
...
<?php
                ...
                ?>
<script>
alert('Gagal: <?php echo mysqli_error($mysqli); ?>');
</script>
<?php
                }
    }
