...
<page backtop="55mm" backbottom="7mm" backleft="7mm" backright="10mm">
    ...
    <table style="width: 100%; border-collapse: collapse;">
        <tr>
    		...
    		$dimensi = mysqli_query($mysqli,"SELECT * FROM dimensi ORDER BY id_dimensi ASC");
    		while ($rdimensi = mysqli_fetch_array($dimensi)) {
    			$datanilaiproject = mysqli_fetch_array(mysqli_query($mysqli,"SELECT AVG(nilai) AS nilai_dimensi FROM nilai_proyek WHERE proyek='$rprojectkelas[id_proyek_kelas]' AND id_dimensi='$rdimensi[id_dimensi]' AND id_siswa='$_GET[orderID]'"));
...
<page backtop="40mm" backbottom="7mm" backleft="7mm" backright="10mm">
    ...
    <table style="width: 100%; border-collapse: collapse; margin-top: 10px;" border="1">
        ...
        while ($rsubelemenproyek = mysqli_fetch_array($subelemenproyek)) {
            ...
            $datanilaiproject2 = mysqli_fetch_array(mysqli_query($mysqli,"SELECT AVG(nilai) AS rata_sub FROM nilai_proyek WHERE proyek='$rprojectkelas[id_proyek_kelas]' AND id_dimensi='$rdimensitunggal[id_dimensi]' AND id_sub_elemen='$rsubelemenproyek[id_sub_elemen]' AND id_siswa='$_GET[orderID]'"));
...
$html2pdf->Output('Rapor P5 '.$siswa['nama_siswa'].'.pdf');
?>